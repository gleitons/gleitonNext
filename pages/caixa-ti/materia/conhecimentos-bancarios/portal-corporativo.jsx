...
export default function PortalCorpora() {
    return (
        <>
            <div className={style.bbody}>
                ...
                <div className={style.inicial}>
                    ...
                    <div>
                        <h3>PORTAIS CORPORATIVOS E COLABORATIVOS</h3>
...
Moral da história? - Não tem moral nenhuma! Foi de sacanagem mesmo... E vê se atende o telefone educadamente, pois posso ser eu ligando para você por engano..</p>
                    </div>
                </div>
            </div>
